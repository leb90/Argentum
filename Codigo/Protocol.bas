...
#End If
        ...
        Else
            ...
            Call ActualizarCuenta(UserIndex, CuentaName, UserName)
        End If
#If SeguridadAlkon Then
    End If
#End If
...
'Cuentas de TonchitoZ
Public Sub HandleCuenta(ByVal UserIndex As Integer)
Dim Command, CuentaName, CuentaPass, CuentaEmail As String
...
With UserList(UserIndex)
    ...
    Select Case Command
        ...
        Case "NewAcc"
            ...
            Call CrearCuenta(UserIndex, CuentaName, CuentaPass, CuentaEmail)
            Exit Sub
           
        Case "DltPJAcc"
            Dim Indexuser As Byte
            Dim gi As Integer 'Guild Index
            CuentaName = .incomingData.ReadASCIIString
            Indexuser = .incomingData.ReadByte

    If gi <= 0 Or gi > CANTIDADDECLANES Then
        Call WriteErrorMsg(UserIndex, "sdgggsdgsdg.")

            Call BorrarPersonaje(UserIndex, CuentaName, Indexuser)
            Else
...
Public Sub EnviarCuenta(ByVal UserIndex As Integer, ByVal PJ1 As String, ByVal PJ2 As String, ByVal PJ3 As String, ByVal PJ4 As String, _
                           ByVal PJ5 As String, ByVal PJ6 As String, ByVal PJ7 As String, ByVal PJ8 As String, ByVal CantPjs As Byte, ByVal estado As Byte)
With UserList(UserIndex).outgoingData
    ...
    .WriteASCIIString (PJ1)
    If PJ1 <> "" Then
        .WriteByte (GetVar(App.Path & "\Charfile\" & PJ1 & ".chr", "INIT", "Clase"))
        .WriteByte (GetVar(App.Path & "\Charfile\" & PJ1 & ".chr", "STATS", "ELV"))
        .WriteLong (GetVar(App.Path & "\Charfile\" & PJ1 & ".chr", "REP", "Promedio"))
    Else
        .WriteByte ("1")
        .WriteByte ("1")
        .WriteLong ("1")
    End If
    .WriteASCIIString (PJ2)
    If PJ2 <> "" Then
        .WriteByte (GetVar(App.Path & "\Charfile\" & PJ2 & ".chr", "INIT", "Clase"))
        .WriteByte (GetVar(App.Path & "\Charfile\" & PJ2 & ".chr", "STATS", "ELV"))
        .WriteLong (GetVar(App.Path & "\Charfile\" & PJ2 & ".chr", "REP", "Promedio"))
    Else
        .WriteByte ("1")
        .WriteByte ("1")
        .WriteLong ("1")
    End If
    .WriteASCIIString (PJ3)
    If PJ3 <> "" Then
        .WriteByte (GetVar(App.Path & "\Charfile\" & PJ3 & ".chr", "INIT", "Clase"))
        .WriteByte (GetVar(App.Path & "\Charfile\" & PJ3 & ".chr", "STATS", "ELV"))
        .WriteLong (GetVar(App.Path & "\Charfile\" & PJ3 & ".chr", "REP", "Promedio"))
    Else
        .WriteByte ("1")
        .WriteByte ("1")
        .WriteLong ("1")
    End If
    .WriteASCIIString (PJ4)
    If PJ4 <> "" Then
        .WriteByte (GetVar(App.Path & "\Charfile\" & PJ4 & ".chr", "INIT", "Clase"))
        .WriteByte (GetVar(App.Path & "\Charfile\" & PJ4 & ".chr", "STATS", "ELV"))
        .WriteLong (GetVar(App.Path & "\Charfile\" & PJ4 & ".chr", "REP", "Promedio"))
    Else
        .WriteByte ("1")
        .WriteByte ("1")
        .WriteLong ("1")
    End If
    .WriteASCIIString (PJ5)
    If PJ5 <> "" Then
        .WriteByte (GetVar(App.Path & "\Charfile\" & PJ5 & ".chr", "INIT", "Clase"))
        .WriteByte (GetVar(App.Path & "\Charfile\" & PJ5 & ".chr", "STATS", "ELV"))
        .WriteLong (GetVar(App.Path & "\Charfile\" & PJ5 & ".chr", "REP", "Promedio"))
    Else
        .WriteByte ("1")
        .WriteByte ("1")
        .WriteLong ("1")
    End If
    .WriteASCIIString (PJ6)
    If PJ6 <> "" Then
        .WriteByte (GetVar(App.Path & "\Charfile\" & PJ6 & ".chr", "INIT", "Clase"))
        .WriteByte (GetVar(App.Path & "\Charfile\" & PJ6 & ".chr", "STATS", "ELV"))
        .WriteLong (GetVar(App.Path & "\Charfile\" & PJ6 & ".chr", "REP", "Promedio"))
    Else
        .WriteByte ("1")
        .WriteByte ("1")
        .WriteLong ("1")
    End If
    .WriteASCIIString (PJ7)
    If PJ7 <> "" Then
        .WriteByte (GetVar(App.Path & "\Charfile\" & PJ7 & ".chr", "INIT", "Clase"))
        .WriteByte (GetVar(App.Path & "\Charfile\" & PJ7 & ".chr", "STATS", "ELV"))
        .WriteLong (GetVar(App.Path & "\Charfile\" & PJ7 & ".chr", "REP", "Promedio"))
    Else
        .WriteByte ("1")
        .WriteByte ("1")
        .WriteLong ("1")
    End If
    .WriteASCIIString (PJ8)
    If PJ8 <> "" Then
        .WriteByte (GetVar(App.Path & "\Charfile\" & PJ8 & ".chr", "INIT", "Clase"))
        .WriteByte (GetVar(App.Path & "\Charfile\" & PJ8 & ".chr", "STATS", "ELV"))
        .WriteLong (GetVar(App.Path & "\Charfile\" & PJ8 & ".chr", "REP", "Promedio"))
    Else
        .WriteByte ("1")
        .WriteByte ("1")
        .WriteLong ("1")
